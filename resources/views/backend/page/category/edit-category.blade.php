		...
		<section class="panel">
			...
			<div class="panel-body">
                            <div class="position-center">
                                ...
                                <form role="form" action="{{route('post-edit-category',['id'=>$cat->id])}}" method="post" >
                                    @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="edit_category_name" class="form-control" id="" placeholder="Nhập tên danh mục " required value="{{$cat->name}}">
                                </div>
                              	<div class="form-group">
                                ...
                                <div class="col-lg-offset-3 col-lg-6">
                                    ...
                                    <a href="{{ route('edit-category',['id'=>$cat->id]) }}"><button

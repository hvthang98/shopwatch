        ...
        <section class="panel">
            ...
            <div class="panel-body">
                            <div class="position-center">
                                ...
                                <form role="form" action="{{route('post-edit-user',['id'=>$user->id])}}" method="post" >
                                    @csrf
                                    @if(count($errors)>0)
                                        @include('error.Note')
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pass" class="form-control" id="pass" value="{{$user->password}}">
                                </div>
                                <div >
                                ...
                                <a href="{{ route('edit-user',['id'=>$user->id]) }}"><button
